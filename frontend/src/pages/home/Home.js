      ...
      <section id="home" className="project-area pt-0">
        <div className="container px-2 px-sm-5 py-5">
          <div className="text-center mt-5">
            <h3 className="text-uppercase">Simple . Safe . Secure</h3>
            <p>SafePad, a new and innovative multi-language Defi LaunchPad</p>
          </div>
          <div className="text-center mt-5">
            <Link to="/presale">
              <button className="btn">Create Now</button>
            </Link>
            <a href="https://winterdog.org/" target="_blank">
          ...
          <div className="row my-5">
            ...
            <div className="col-12 col-md-6 col-xl-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p className="">
                  Adding logo, social links, description, listing on SafePad.
                </p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-xl-3">
            ...
            <div className="col-12 col-md-6 col-xl-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p>Promote your launchpad to thousands of buyers on SafePad.</p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-xl-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p>Lock your liquidity to PancakeSwap after presale.</p>
              </div>
            </div>
          </div>
          <div className="row">
